import type { GuardianRosterStatus, VettingStatus } from '@/types/guardian-roster';
...
const vettingStyles: Record<VettingStatus, string> = {
  VERIFIED: 'bg-green-100 text-green-800',
  EXPIRING: 'bg-amber-100 text-amber-800',
  PENDING: 'bg-amber-100 text-amber-800',
};

const vettingLabels: Record<VettingStatus, string> = {
  VERIFIED: 'Verified',
  EXPIRING: 'Expiring',
  PENDING: 'Pending',
};
